                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center justify-start">
                                            ...
                                            <Link href="{{ route('dashboard') }}" class="flex ml-2 md:mr-24">
                                                <img src="{{ asset('logo/logo.png') }}" class="h-8 mr-3" alt="Abus Logo" />
                                                <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">e-abus</span>
                                            </Link>
                                        </div>
