    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <div class="flex flex-col mb-4">
                    <Link href="https://flowbite.com/" class="flex items-center mb-2">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white mr-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white "> UPT Puskesmas Sukamulya :</span>
                    </Link>
                    <span class="text-sm"> Jln. Sukamulya No. 12 Kp. Sukahurip RT/RW 001/006 </span>
                    <span class="text-sm"> Desa Sukamulya Kecamatan Sukaresmi Kabupaten Garut Provinsi Jawa barat Kodepos 44163</span>
                </div>

                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d782.0336940737262!2d107.79793566849222!3d-7.259300255434176!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68a4d10001ea73%3A0x413df03845304f7d!2sUPT%20PUSKESMAS%20SUKAMULYA!5e1!3m2!1sid!2sid!4v1706223244687!5m2!1sid!2sid" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <Link away href="https://www.kemkes.go.id/" class="hover:underline">Kemkes</Link>
                        </li>
                        <li class="mb-4">
                            <Link away href="https://diskes.jabarprov.go.id/" class="hover:underline">Dinkes Prov. Jabar</Link>
                        </li>
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024
                <Link href="https://flowbite.com/" class="hover:underline">Abus™</Link>. All Rights Reserved.
            </span>
