        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <x-splade-form :action="route('admin.roles.store')" class="p-4 bg-white rounded-md space-y-2">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <x-splade-submit/>
                <button type="button" @click="modal.close" class="ms-3 text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Cancel</button>
                </div>
            </x-splade-form>
</x-splade-modal>
